            ...
            'place_image_from_pixel_buffer': function(pixel_buffer, dest_pos) {
                ...
                if (this.bits_per_pixel == 32 && pixel_buffer.bits_per_pixel == 32) {
                    ...
                    for (var y = 0; y < source_h; y++) {
                        var source_buffer_line_start_pos = y * source_buffer_line_length;
                        var source_buffer_line_end_pos = source_buffer_line_start_pos + source_buffer_line_length;
                        
                        var dest_buffer_subline_start_pos = (y + dest_pos[1]) * dest_buffer_line_length;
                        var dest_buffer_subline_end_pos = dest_buffer_subline_start_pos + source_buffer_line_length;
                        
                        // buf.copy(targetBuffer, [targetStart], [sourceStart], [sourceEnd])
                        
                        source_buffer.copy(dest_buffer, dest_buffer_subline_start_pos, source_buffer_line_start_pos, source_buffer_line_end_pos);
